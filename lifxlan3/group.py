...
from lifxlan3.network.msgtypes import GetService, StateService
from lifxlan3.devices.multizonelight import MultizoneLight
from lifxlan3.network.network import broadcast_with_resp
