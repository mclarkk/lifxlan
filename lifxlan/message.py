...
BROADCAST_MAC = b'00:00:00:00:00:00'
...
class Message(object):
    ...
    def get_payload(self):
        return little_endian(bitstring.pack(b''))
    ...
    def __str__(self):
        ...
        s += indent + 'Target MAC Address: {}\n'.format(self.target_addr.decode('utf8'))
...
def convert_MAC_to_int(addr):
    reverse_bytes_str = addr.split(b':')
    reverse_bytes_str.reverse()
    addr_str = b''.join(reverse_bytes_str)
