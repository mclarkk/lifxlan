...
def main():
    ...
    for product in mapdata:
        # i += 1
        if (
            "temperature_range" in product["features"]
            and product["features"]["temperature_range"][0]
